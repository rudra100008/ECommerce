...
import com.E_Commerce.Helper.AddressHelper;
...
public class AddressController {
    ...
    public ResponseEntity<?> fetchAllProvinceData(){
        ...
        List<ProvinceResponse> provinceResponses = addressHelper.toProvinceResponse(provinces);
    ...
    public ResponseEntity<?> fetchDistrictByProvinceId(
        ...
        List<DistrictResponse> districtResponses = addressHelper.toDistrictResponse(districts);
    ...
    public ResponseEntity<?> fetchMunicipalityByDistrictId(
        ...
        List<MunicipalityResponse> municipalityResponse = addressHelper.toMunicipalityResponse(municipalities);
        return ResponseEntity.status(HttpStatus.OK)
