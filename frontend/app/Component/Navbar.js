    ...
    <div className={style.container}>
      <div className={style.NavbarContainer}>
        ...
        <div className={style.navbarItems}>
          ...
          <div className={style.navbarItem}>
            <FontAwesomeIcon className={style.orderIcon} icon={faClipboard} />
          </div>
          <div className={style.navbarItem}>
            <FontAwesomeIcon
            ...
            >
              {userData?.profileImageUrl ? (
                ...
                <div className={style.noImage}>
                  <p>{userData?.username?.charAt(0).toUpperCase() || "U"}</p>
                </div>
              )}
              {showUserBox && (
                <div ref={userBoxRef} className={style.profileMenu}>
      ...
      <div className={style.subNavbar}>
        <div className={style.subnavItems}>
          ...
          <Link
            href="/shop"
            className={`${style.subnavItem} ${
              activeNavItem === "shop" ? style.active : ""
            }`}
          >
            Shop
          </Link>
          <Link
            href="/cart"
            className={`${style.subnavItem} ${
              activeNavItem === "cart" ? style.active : ""
            }`}
          >
            Cart
          </Link>
          <Link
            href="/contact"
            className={`${style.subnavItem} ${
              activeNavItem === "contact" ? style.active : ""
            }`}
          >
            Contact
          </Link>
