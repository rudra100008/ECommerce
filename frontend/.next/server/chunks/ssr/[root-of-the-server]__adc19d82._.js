...
;
;
const fetchCurrentUser = async (success, error)=>{
    try {
...
function NavigationProvider({ children }) {
    ...
    const loadCurrentUser = async ()=>{
        setUserLoading(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$UserServices$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCurrentUser"])(success, error);
            setUserData(data);
        } catch (error) {
...
function CartProvider({ children }) {
    const [cartUpdateTrigger, setCartUpdateTrigger] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
...
const useCart = ()=>{
    ...
    if (!context) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$error$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]("useCart must be withing CartProvider");
    }
    return context;
};
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__adc19d82._.js.map