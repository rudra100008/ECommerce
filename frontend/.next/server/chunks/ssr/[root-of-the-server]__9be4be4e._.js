...
(()=>{
    const e = new Error("Cannot find module '../baseUrl'");
...
function LoginPage() {
    ...
    const login = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Component$2f$axiosInterceptor$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${baseURL}/api/auth/login`, user);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9be4be4e._.js.map