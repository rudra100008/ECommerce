...
function Home() {
    ...
    const loadCurrentUser = async ()=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$LoginServices$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCurrentUser"])();
            setUserData((prev)=>({
                    ...prev,
                    ...data
                }));
