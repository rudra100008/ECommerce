...
function NavigationProvider(param) {
    let { children } = param;
    _s();
    const [activeNavItem, setActiveNavItem] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
...
_s(NavigationProvider, "q0fFnWvpi7kdMUcFx2BCUb3tSsQ=");
...
function Navbar(param) {
    let {} = param;
    _s();
    const { userData, activeNavItem, handleItemClick } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Context$2f$NavigationContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNavigation"])();
...
_s(Navbar, "digksPbCOdjTLfoTXgbGOqy6FFk=", false, function() {
    return [
...
//# sourceMappingURL=app_22be2fe8._.js.map