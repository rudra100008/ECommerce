...
function NavigationProvider(param) {
    ...
    const [isRedirecting, setIsRedirecting] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Prevent multiple redirects
        ...
        "NavigationProvider.useCallback[loadCurrentUser]": async ()=>{
            ...
            try {
                ...
                if (((_err_response = err.response) === null || _err_response === void 0 ? void 0 : _err_response.status) === 401) {
                    ...
                    }["NavigationProvider.useCallback[loadCurrentUser]"], 500);
                } else {
...
//# sourceMappingURL=app_9c227084._.js.map