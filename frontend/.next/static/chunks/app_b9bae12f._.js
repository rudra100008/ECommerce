...
function NavigationProvider(param) {
    ...
    const loadCurrentUser = async ()=>{
        setUserLoading(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$UserServices$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCurrentUser"])(success, error);
            setUserData(data);
        } catch (error) {
...
_s(CartProvider, "O3nO8pBXX9SJzACcyqlcy4+/nC4=", false, function() {
    return [
...
const useCart = ()=>{
    ...
    if (!context) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$error$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]("useCart must be withing CartProvider");
    }
    return context;
};
...
//# sourceMappingURL=app_b9bae12f._.js.map